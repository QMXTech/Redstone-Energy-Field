...
public abstract class BaseEnergyBlock extends Block {
    ...
    protected boolean isProvidingPower(IBlockAccess blockAccess, int x, int y, int z) {
        List ignoreList = Handler.getIgnoreList();
